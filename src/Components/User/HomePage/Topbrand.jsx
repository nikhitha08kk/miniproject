...
function Topbrand() {
  return (
    ...
    <div className=' top'>
       ...
       <div><img className="bul" alt='brand' src='https://www.perfume24x7.com/cdn/shop/files/bvlgari.jpg?v=1623589433&width=180'></img></div>
       <div><img alt='brand' src='https://www.perfume24x7.com/cdn/shop/files/Carolina-Herrera.jpg?v=1629915192&width=180'></img></div>
       <div><img alt='brand' className="eli"  src='https://www.perfume24x7.com/cdn/shop/files/Elizabeth-Arden-Emblem.png?v=1633858292&width=180'></img></div>
